...
var EDGE_VERSION = '1-132.0.2957.140';
var WINDOWS_FILE_TIME_EPOCH = BigInt("11644473600");
...
export function generateSecMsGecToken() {
  return _generateSecMsGecToken.apply(this, arguments);
}
function _generateSecMsGecToken() {
  _generateSecMsGecToken = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var ticks, roundedTicks, strToHash, crypto, hash;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ticks = BigInt(Math.floor(Date.now() / 1000 + Number(WINDOWS_FILE_TIME_EPOCH))) * BigInt("10000000");
          roundedTicks = ticks - ticks % BigInt("3000000000");
          strToHash = roundedTicks + EDGE_API_TOKEN;
          _context3.next = 5;
          return import("../utils/getSHA256");
        case 5:
          crypto = _context3.sent;
          hash = crypto.hash(strToHash);
          return _context3.abrupt("return", hash.toUpperCase());
        case 8:
        case "end":
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(_ref) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 10:
          _context2.next = 12;
          return generateSecMsGecToken();
        case 12:
          _context2.t2 = _context2.sent;
        case 13:
          _context2.t3 = _context2.t2;
          _context2.t4 = token ? token : EDGE_VERSION;
          _context2.t5 = token ? token : EDGE_API_TOKEN;
          _context2.t6 = {
            ConnectionId: _context2.t1,
            'Sec-MS-GEC': _context2.t3,
            'Sec-MS-GEC-Version': _context2.t4,
            TrustedClientToken: _context2.t5
          };
          _context2.t7 = proxyUrl ? proxyUrl : EDGE_SPEECH_URL;
          _context2.t8 = {
            query: _context2.t6,
            url: _context2.t7
          };
          url = _context2.t0.stringifyUrl.call(_context2.t0, _context2.t8);
