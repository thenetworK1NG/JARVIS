...
var _excluded = ["autoFocus", "classNames", "styles", "defaultValue", "onChange", "placeholder", "style", "className", "onValueChange", "value", "language", "variant", "width", "height", "flex", "ref"];
...
var CodeEditor = /*#__PURE__*/memo(function (_ref) {
  ...
  var _useMergeState = useMergeState(defaultValue, {
    ...
    code = _useMergeState2[0],
    setCode = _useMergeState2[1];
  ...
  return /*#__PURE__*/_jsxs(Flexbox, {
    ...
    style: style,
    width: width,
    children: [value ? /*#__PURE__*/_jsx(SyntaxHighlighter, {
      className: cx(styles.highlight, classNames === null || classNames === void 0 ? void 0 : classNames.highlight),
      language: language,
      style: customStyles === null || customStyles === void 0 ? void 0 : customStyles.highlight,
      variant: variant,
      children: value
    }) : /*#__PURE__*/_jsx("pre", {
      className: cx(styles.highlight, classNames === null || classNames === void 0 ? void 0 : classNames.highlight),
      ...
      ref: ref,
      style: customStyles === null || customStyles === void 0 ? void 0 : customStyles.textarea,
      value: code
    }, rest))]
  });
});
